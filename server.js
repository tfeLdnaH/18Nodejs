...
/*
C:\Users\Anderson\Desktop\PytonGitUI5JSAngularETC\NodeJS\src>curl -i -X GET http://localhost:8080/pages/home
HTTP/1.1 200 OK
Content-Type: text/html
Date: Sun, 05 Nov 2017 15:23:51 GMT
...
<html>
  <head>
    ...
    <!-- Javascript -->
    <script src="http://localhost:8080/content/jquery-3.1.1.js"
            type="text/javascript"></script>
    <script src="http://localhost:8080/content/mustache.js"
            type="text/javascript"></script>
    <script src="http://localhost:8080/content/home.js"
            type="text/javascript"></script>
  </head>
  <body>
    Loading... If this fails to disappaer in a second, then look in your
